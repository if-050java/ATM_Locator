...
/*Data for the table `atmnetworks` */

insert  into `atmnetworks`(`Id`,`name`) values (-1,'Unassigned'),(1,'Приватбанк'),(2,'Атмосфера'),(3,'Euronet'),(4,'Радiус'),(5,'УкрКард');
...
/*Data for the table `parser_params` */
...
insert  into `roles`(`id`,`description`,`name`) values (1,'Role for administrators','ADMIN'),(2,'Role for registered users','USER');
...
insert  into `user_role`(`users_id`,`roles_id`) values (1,1),(3,1),(1,2),(2,2),(3,2);
